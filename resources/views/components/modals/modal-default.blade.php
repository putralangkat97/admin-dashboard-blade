<div class="fixed z-50 inset-0" x-data="{ showModal1: false }" x-show="showModal1" x-on:open-modal-1.window="showModal1 = true"
    ...
    <div class="bg-white mx-auto mt-16 fixed inset-0 max-w-xl p-6 flex flex-col justify-between h-72">
        ...
        <div class="space-x-2 self-end">
            <button type="button"
                class="py-2 px-4 inline-flex justify-center items-center border border-transparent font-semibold text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all text-sm" @click="showModal1 = false">
                Close
            </button>
            <button type="button"
