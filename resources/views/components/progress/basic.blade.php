<div {{ $attributes->merge(['class' => '']) }}>
    ...
    <div class="flex w-full lg:w-1/2 h-1.5 bg-gray-200 overflow-hidden">
        <div class="flex flex-col justify-center overflow-hidden bg-yellow-500" role="progressbar" style="width: 35%"
            aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
    <div class="flex w-full lg:w-1/2 h-1.5 bg-gray-200 overflow-hidden">
        <div class="flex flex-col justify-center overflow-hidden bg-orange-500" role="progressbar" style="width: 60%"
            aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
    <div class="flex w-full lg:w-1/2 h-1.5 bg-gray-200 overflow-hidden">
