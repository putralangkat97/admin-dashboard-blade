<div {{ $attributes->merge(['class' => '']) }}>
    <div>
        <div class="w-80 bg-zinc-900 text-sm text-white shadow" role="alert" x-data="{ open: true }" x-show="open"
    ...
    <div>
        <div class="w-80 bg-blue-500 text-sm text-white shadow" role="alert" x-data="{ open: true }" x-show="open"
            x-transition:leave.duration.300ms>
            <div class="flex p-4">
                Hello, world! This is a toast message.
                <div class="ml-auto">
    ...
    <div>
        <div class="w-80 bg-yellow-500 text-sm text-white shadow" role="alert" x-data="{ open: true }" x-show="open"
            x-transition:leave.duration.300ms>
            <div class="flex p-4">
                Hello, world! This is a toast message.
                <div class="ml-auto">
    ...
    <div>
        <div class="w-80 bg-orange-500 text-sm text-white shadow" role="alert" x-data="{ open: true }" x-show="open"
            x-transition:leave.duration.300ms>
            <div class="flex p-4">
                Hello, world! This is a toast message.
                <div class="ml-auto">
    ...
    <div>
        <div class="w-80 bg-green-500 text-sm text-white shadow" role="alert" x-data="{ open: true }" x-show="open"
            x-transition:leave.duration.300ms>
            <div class="flex p-4">
                Hello, world! This is a toast message.
                <div class="ml-auto">
