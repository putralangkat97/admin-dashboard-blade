...
<div>
    <div class="w-80 bg-yellow-200 text-sm text-yellow-600 shadow" role="alert" x-data="{ open: true }" x-show="open"
        x-transition:leave.duration.300ms>
        <div class="flex p-4">
            Hello, world! This is a toast message.
            <div class="ml-auto">
...
<div>
    <div class="w-80 bg-orange-200 text-sm text-orange-600 shadow" role="alert" x-data="{ open: true }" x-show="open"
        x-transition:leave.duration.300ms>
        <div class="flex p-4">
            Hello, world! This is a toast message.
            <div class="ml-auto">
...
<div>
    <div class="w-80 bg-green-200 text-sm text-green-600 shadow" role="alert" x-data="{ open: true }" x-show="open"
        x-transition:leave.duration.300ms>
        <div class="flex p-4">
            Hello, world! This is a toast message.
            <div class="ml-auto">
