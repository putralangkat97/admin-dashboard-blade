...
<div class="fixed z-50 inset-0" x-data="{ showModal4: false }" x-show="showModal4" x-on:open-modal-4.window="showModal4 = true"
    x-transition.opacity.duration.200ms>
    <div class="fixed inset-0 bg-gray-900 opacity-50" @click="showModal4 = false">
    </div>
    <div class="bg-white m-auto fixed inset-0 max-w-xl flex flex-col justify-between h-96">
